      ...
      <div className="w-full max-w-sm">
        ...
        <Card className="bg-nest-surface border border-[rgba(255,255,255,0.08)] rounded-[14px]">
          <CardHeader className="pb-2 pt-6 px-6">
            <h1 className="text-lg font-medium text-nest-primary">Welcome back</h1>
            <p className="text-sm text-nest-secondary mt-1">Sign in to your operator account.</p>
          </CardHeader>
          <CardContent className="px-6 pb-6">
            ...
            <p className="text-center text-sm text-nest-secondary mt-5">
              No account?{" "}
              <Link href="/signup" className="text-nest-accent hover:underline">
                Get started free
              </Link>
            </p>
          </CardContent>
